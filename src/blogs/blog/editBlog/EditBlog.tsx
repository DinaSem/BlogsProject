...
export const EditBlog = () => {
    ...
    const {id}= useParams()
    let blog = useAppSelector(state => state.blogs.blogsData.items.find(b=>b.id===id))
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            if(id){
                dispatch(changeBlogTC(id,values.blogName,values.website,values.description))
            }
            navigate(`/`)
        },
    });
